...
class Villain3 extends Person3 {
    ...
    // Constructor
    Villain3() {}
    Villain3(String name, int age, int height, int weight, String unique_key, int weapon, double power) {
...
public class Class_9 {
    public static void main(String[] args) {
        ...
        // [1] : 객체 생성
        Villain3 v1 = new Villain3("좀비", 20, 180, 80, "15001231", 2, 99.5);
        v1.printPerson3();
        System.out.print(v1.getName() + " ");
        v1.move();  // 부모 클래스의 move() 메서드를 호출.

        // [2] : 객체 생성
        Villain3 v2 = new Villain3("도깨비", 30, 175, 70, "11001121", 1, 77.5);
        v2.printPerson3();
        System.out.print(v2.getName() + " ");
        v2.move();

        // [3] : 객체 생성
        Villain3 v3 = new Villain3("몽달귀신", 40, 150, 40, "10001010", 3, 27.5);
        v3.printPerson3();
